...
generated quantities{
    ...
    for (j in 1:Npred){
        ...
        ypred[j] = normal_rng(a + b[1]*X1pred[j] + b[2]*X2pred[j] + b[3]*X3pred[j] + b[4]*X4pred[j] + b[5]*X5pred[j] + b[6]*X11pred[j] + b[7]*X22pred[j] + b[8]*X33pred[j] + b[9]*X44pred[j] + b[10]*X55pred[j] + b[11]*X2X4pred[j] + b[12]*X3X5pred[j] + b[13]*X1X5pred[j] + b[14]*X2X5pred[j], sigma);
    } 
