...
generated quantities{
    ...
    for (j in 1:Npred){
        ...
        ypred_2018[j] = normal_rng(a + b[1]*X1pred[j] + b[2]*X2pred[j] + b[3]*X3pred[j] + b[4]*X4pred[j] + b[5]*X5pred[j] + b[6]*X2X4pred[j] + b[7]*X3X5pred[j] + b[8]*X1X5pred[j] + b[9]*X2X5pred[j], sigma);
        ypred[j] = normal_rng(a + b[1]*X1[j] + b[2]*X2[j] + b[3]*X3[j] + b[4]*X4[j] + b[5]*X5[j] + b[6]*X2X4[j] + b[7]*X3X5[j] + b[8]*X1X5[j] + b[9]*X2X5[j], sigma);
    } 
