...
generated quantities{
    ...
    for (j in 1:Npred){
        ...
        ypred[j] = normal_rng(a + b[1]*X1[j] + b[2]*X2[j] + b[3]*X3[j] + b[4]*X4[j] + b[5]*X5[j] + b[6]*X11[j] + b[7]*X22[j] + b[8]*X33[j] + b[9]*X44[j] + b[10]*X55[j] + b[11]*X2X4[j] + b[12]*X3X5[j] + b[13]*X1X5[j] + b[14]*X2X5[j], sigma);
